 ...
 * @since 3.0.0
 */
class WC_Gateway_Alphapaypal_API_Handler {
	...
	public static function do_capture( $order, $amount = null ) {
		...
		WC_Gateway_Alphapaypal::log( 'DoCapture Response: ' . wc_print_r( $raw_response, true ) );
	...
	public static function refund_transaction( $order, $amount = null, $reason = '' ) {
		...
		WC_Gateway_Alphapaypal::log( 'Refund Response: ' . wc_print_r( $raw_response, true ) );
 ...
 * @since 3.0.0
 */
class WC_Gateway_Alphapaypal_Refund extends WC_Gateway_Alphapaypal_API_Handler {
