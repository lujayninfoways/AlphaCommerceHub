 ...
 */
class WC_Gateway_Alphapaypal_Request {
	...
	/**
	 * Constructor.
	 * @param WC_Gateway_Alphapaypal $gateway
	 */
	public function __construct( $gateway ) {
		$this->gateway    = $gateway;
		$this->notify_url = WC()->api_request_url( 'WC_Gateway_Alphapaypal' );
	}
	...
	public function get_request_url( $order, $sandbox = false ) {
		...
		WC_Gateway_Alphapaypal::log( 'PayPal Request Args for order ' . $order->get_order_number() . ': ' . wc_print_r( $paypal_args, true ) );
	...
	protected function get_paypal_args( $order ) {
		WC_Gateway_Alphapaypal::log( 'Generating payment form for order ' . $order->get_order_number() . '. Notify URL: ' . $this->notify_url );
